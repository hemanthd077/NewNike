    ...
    <div class="columnFlex OuterBlock">
        <div class="rowFlex menuBlock">
            ...
            <div class="rowFlex mainButton">
                ...
                <form method="get" action="about" href="about.jsp" ><input value="ABOUT" class="activeState" type="submit"></form>
        ...
        <div>
            <section class="intro">
            <h2>Our Story</h2>
            <p>Nike, Inc., named after the Greek winged goddess of victory, is the world's leading designer, marketer, and distributor of authentic athletic footwear, apparel, equipment, and accessories for a wide variety of sports and fitness activities...</p>
            </section>

            <section class="mission">
                <h2>Our Mission</h2>
                <p>Our mission is to bring inspiration and innovation to every athlete in the world. If you have a body, you are an athlete...</p>
            </section>
            ...
            <section class="team">
                <h2>Our Team</h2>
                <p>We are a diverse team of individuals who share a passion for sports, creativity, and innovation. Our team is dedicated to creating products that empower athletes and inspire everyone to reach their full potential...</p>
            </section>

            <section class="contact">
                <h2>Contact Us</h2>
                <p>For inquiries, please email us at info@nike.com or visit our headquarters at...</p>
                <p>he****@gmail.com</p>
            </section>
        </div>
        <footer>
